...
.volume_excel_labels <- function() c(
  ...
  height_m = "Height (m)", basal_area_m2 = "Basal area (\u00b2)",
  ...
  volume_m3_ha = "Volume (\u00b3/ha)",
  mean_volume_m3_ha = "Mean volume (\u00b3/ha)",
  sd_volume_m3_ha = "Volume SD (\u00b3/ha)",
  se_volume_m3_ha = "Volume SE (\u00b3/ha)",
  ci95_lower_volume_m3_ha = "Volume 95% CI lower (\u00b3/ha)",
  ci95_upper_volume_m3_ha = "Volume 95% CI upper (\u00b3/ha)",
  total_forest_volume_m3 = "Total forest volume (\u00b3)",
  mean_tree_volume_m3 = "Mean tree volume (\u00b3/tree)",
  mean_plot_volume_m3_ha = "Mean plot volume (\u00b3/ha)",
  se_plot_volume_m3_ha = "Plot volume SE (\u00b3/ha)",
  ci95_lower_plot_volume_m3_ha = "Plot volume 95% CI lower (\u00b3/ha)",
  ci95_upper_plot_volume_m3_ha = "Plot volume 95% CI upper (\u00b3/ha)",
  plot_area_design = "Plot-area design",
  coverage_status = "Coverage status",
  uncertainty_status = "Uncertainty status",
  summary_status = "Summary status",
  frtc_total_volume_m3 = "FRTC total over-bark stem volume (\u00b3/tree)",
  frtc_volume_ub_20cm_m3 = "FRTC under-bark volume to 20-cm top (\u00b3/tree)",
  frtc_volume_ub_10cm_m3 = "FRTC under-bark volume to 10-cm top (\u00b3/tree)",
  ...
  sharma_pukkala_stem_volume_m3 = "Sharma\u2013Pukkala stem volume (\u00b3/tree)",
  sharma_pukkala_branch_volume_m3 = "Regulatory branch volume (\u00b3/tree)",
  sharma_pukkala_total_tree_volume_m3 = "Sharma\u2013Pukkala total tree volume (\u00b3/tree)",
