...
status. Carbon is calculated using the IPCC (2006) default fraction of 0.47.
...
Users should cite `nepalallometry`, the original FRTC (2025) report, and IPCC
(2006) when using the default carbon fraction. Run `allometry_references()` for
the complete APA-style package reference registry.
